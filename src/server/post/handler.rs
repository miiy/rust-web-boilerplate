...
pub async fn detail(
    ...
    let req = DetailRequest { id };
    let resp = super::service::detail(&req, &app_state.post_client).await?;
...
pub async fn create(app_state: web::Data<AppState>) -> Result<HttpResponse, Error> {
    ...
    let _resp = super::service::create(&req, &app_state.post_client).await?;
...
pub async fn edit(
    ...
    let _resp = super::service::edit(&req, &app_state.post_client).await;
